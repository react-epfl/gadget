...
public class ConversionOfCoordinatesComet
{
	public ConversionOfCoordinatesComet(){
	...
	public void convert()
	{
		...
		try{
			FileReader file = new FileReader("/Users/wissam/gadget/sismondi/comet3d.txt");
			PrintWriter writerAll = new PrintWriter("/Users/wissam/gadget/sismondi/comet2d.txt");
			PrintWriter writer = new PrintWriter("/Users/wissam/gadget/sismondi/plot_comet.txt");
...
public static void main(String args[])
	{
		ConversionOfCoordinatesComet con = new ConversionOfCoordinatesComet();
		con.convert();
	}
}