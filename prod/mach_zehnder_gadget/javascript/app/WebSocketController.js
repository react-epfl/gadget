myApp.controller('WebSocketController', ['$scope', function($scope) {
                        ...
                        if (msg.sensorId != "Info") {
                            ...
                            if (msg.responseData) {
                                ...
                                if (Q_Size == 0) {
                                    ...
                                    if (!controller) {
                                        setTimeout (function() {
                                            configureSD($scope.laserIsOn, bs1IsActivated, bs2IsActivated, [parseFloat(piezoVoltageSlider.noUiSlider.get()[0]),0], filterIsActivated);
                                        }, 700);
                                        controller = 1;
                                    }
                                }
    ...
    function createChart() {
        ...
        var xVal = 0,
            updateInterval = 100,
            dataLength = 200; // number of dataPoints visible at any point
